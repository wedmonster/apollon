...
<body>
	...
	<br/><br/><br/><br/>
		...
		<div align="center" style="border:1px solid #ddd">
			<br/>
			<br/>
			<div><h4>Write your ID and Password to join.</h4></div>
			<form name="join_form" method="post" action="join.do">	
			<table border="0">
				<tr>
					<td><font>Your ID</font></td>
					<td>					
						<input type="text" value=" " name="user" style="width:110px;"/>
					</td>
				</tr>
				<tr>
					<td><font>Password</font></td>
					<td>
						<input type="password" value=" " name="user_password" style="width:110px;"/>						
					</td>
				</tr>
				<tr><td><br/></td></tr>
				<tr align="center">
					...
					<td>
					<input type="submit" value="Join" style="width:80px;" />					
					</td>
				</tr>
			</table>
			</form>					
